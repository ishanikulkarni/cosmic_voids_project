...
for w in wiggles:
    for realization in range(0,num_realizations):
        filewrite = '/tigress/isk/COLA_runs/plot_data/sampling/z0Quijote/' + w + '_Quijote_' + str(realization)+'_voids_rs0_drdefault.dat'
        
        if not os.path.exists(filewrite):
            filenw = '/projects/SPERGEL/COLA_runs/voidcatalogs/z0Quijote/Quijote_ss1.0/sample_Quijote_' +w + '_'+str(realization)+'_halos_z0.00/centers_central_Quijote_' + w+'_'+ str(realization) +'_halos_z0.00.out'
...
for w in wiggles:
    ...
    file = '/tigress/isk/COLA_runs/plot_data/z'+zlab+sim+'/Xivv_100AVG_ERROR_'+w+'_nbodykit_original_halos_rs0'+scale+'_drdefault.dat'
...
ax.plot(plotarr['wigglesr'],plotarr['wigglesr']**2.0*(plotarr['wigglesavgcorr'] - plotarr['no-wigglesavgcorr']), label = 'Original Redshift 0')
