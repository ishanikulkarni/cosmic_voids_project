...
for (zlab,redshift) in zip(zlabs,redshifts):
    for wiggle in wiggles:
        for realization in range(0,num_realizations):
            newfile = '/projects/SPERGEL/COLA_runs/mass_data/z'+zlab+sim+'/'+sim+'_'+wiggle+'_small_mcut1e13_'+str(realization)+'_halos.dat'
            ...
            if not os.path.exists(newfile):
                ...
                #print(newfile)
                select_array=data_array[data_array[7]<10**13]
