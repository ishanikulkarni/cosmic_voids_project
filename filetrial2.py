...
for w in wiggles:
    for realization in range(0,num_realizations):
        ...
        if not os.path.exists(filewrite):
            ...
            #filenw = '/projects/SPERGEL/COLA_runs/voidcatalogs/z1Quijote/Quijote_ss1.0/sample_Quijote_' +w + '_'+str(realization)+'_halos_z1.00/centers_central_Quijote_' + w+'_'+ str(realization) +'_halos_z1.00.out'
            filenw = '/projects/SPERGEL/COLA_runs/voidcatalogs/z1Quijote/Quijote_ss1.0/sample_Quijote_'+w+'_large_mcut1e13pt5_'+str(realization)+'_halos_z1.00/centers_central_Quijote_'+w+'_large_mcut1e13pt5_'+str(realization)+'_halos_z1.00.out'
